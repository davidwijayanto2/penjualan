...
class PrintNotaLogo extends StatefulWidget {
  final HJual hJual;
  final List<DJual> dJualList;
  const PrintNotaLogo(this.hJual, this.dJualList, {Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() =>
      PrintNotaLogoState(this.hJual, this.dJualList);
}

class PrintNotaLogoState extends State<PrintNotaLogo> {
  final HJual hJual;
  final List<DJual> dJualList;
  PrintNotaLogoState(this.hJual, this.dJualList);
    ...
    return pw.Row(
      children: [
        ...
        pw.Container(
          ...
          alignment: pw.Alignment.topRight,
          child: pw.Text(
            thousandSeparator(hJual.grandTotal, separator: '.'),
            style: pw.TextStyle(
              fontSize: 7,
              font: ttf,
            ),
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  for (int index = 0; index < dJualList.length; index++)
                    index == dJualList.length - 1 && index == 0
                        ? pw.Column(
                            children: [
                              rowHeader(ttf),
                              rowItem(index, ttf),
                  ...
                  if ((hJual.rekening ?? '').isNotEmpty) ...[
                    pw.SizedBox(height: CommonHelpers.convertMMtoPx(mm: 30)),
                    pw.Row(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        pw.Text(
