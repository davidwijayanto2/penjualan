...
class LaporanStokMasukView extends LaporanStokMasukController {
  @override
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: listStokMasuk?.length,
              itemBuilder: (BuildContext context, int index) {
                return _item(index, listStokMasuk?[index]);
              },
            ),
          ),
          CommonWidgets.horizontalDivider(),
  ...
  _item(int index, StokMasuk? stokMasuk) {
    return Container(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CommonText.text(
                  text: "Jumlah: ${stokMasuk?.jumlah ?? '0'}",
                  style: CommonText.body1(
