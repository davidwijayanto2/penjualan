...
const double _kDatePickerHeaderPortraitHeight = 36.0;
...
//    @required this.orientation,
  ...
  Widget build(BuildContext context) {
    ...
    final Widget endHeader = selectedLastDate != null
        ...
        : new Container();
    var textDate = selectedFirstDate != null
        ? DateFormatter.toShortDateText(context, selectedFirstDate)
        : 'Start Date';
    textDate += (selectedLastDate != null)
        ? ' - ' + DateFormatter.toShortDateText(context, selectedLastDate!)
        : ' - ' + DateFormatter.toShortDateText(context, selectedFirstDate);
    final Widget customHeaderWidget = CommonText.text(
    ...
    return new Container(
        ...
        child: new Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [customHeaderWidget, iconHeader],
        )
...
class DayPicker extends StatelessWidget {
  ...
  /// 4 5 6 7 8 9 10
  /// ```
  List<Widget> _getDayHeaders(TextStyle normalStyle, TextStyle sundayStyle,
    ...
    for (int i = localizations.firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      ...
      result.add(new ExcludeSemantics(
        child: new Center(
            child:
                new Text(weekday, style: i == 0 ? sundayStyle : normalStyle)),
      ));
  ...
  Widget build(BuildContext context) {
    ...
    labels.addAll(_getDayHeaders(CommonText.body2(color: MyColors.white),
        CommonText.body2(color: MyColors.themeColor1), localizations));
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        TextStyle itemStyle = (i % 7 == 0)
            ? CommonText.body2(color: MyColors.themeColor1)
            : CommonText.body2(color: MyColors.textGray);
        ...
        if (isSelectedFirstDay &&
          ...
          itemStyle = CommonText.body2(color: MyColors.white);
          decoration = new BoxDecoration(
              color: MyColors.themeColor1, shape: BoxShape.circle);
          ...
          itemStyle = CommonText.body2(color: Colors.white);
          decoration = new BoxDecoration(
              color: MyColors.themeColor1.withOpacity(0.7),
              shape: BoxShape.rectangle);
        } else if (disabled) {
          itemStyle =
              CommonText.body2(color: MyColors.textGray.withOpacity(0.5));
        } else if (currentDate.year == year &&
            currentDate.month == month &&
            currentDate.day == day) {
          // The current day gets a different text color.
          itemStyle = CommonText.body2(color: MyColors.themeColor1);
        }
        ...
        child: Row(
          ...
          children: <Widget>[
            GestureDetector(
                ...
                child: CommonText.text(
                    text: 'Clear Filter',
                    style: CommonText.body2(color: MyColors.black))),
            SizedBox(width: 5),
            CommonWidgets.containedButton(
              text: 'Set Filter',
              textStyle: CommonText.body2(color: MyColors.white),
              width: 130,
